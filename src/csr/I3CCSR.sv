...
module I3CCSR (
    ...
    always_comb begin
        ...
        decoded_reg_strb.I3C_EC.SoCMgmtIf.SYS_CLK_FREQ_REG = cpuif_req_masked & (cpuif_addr == 12'h25c);
    ...
    always_comb begin
        ...
        if(decoded_reg_strb.I3CBase.RESET_CONTROL && decoded_req_is_wr) begin // SW write
            ...
            load_next_c = '1;
        end else if(hwif_in.I3CBase.RESET_CONTROL.SOFT_RST.hwclr) begin // HW Clear
            next_c = '0;
            load_next_c = '1;
        end
    ...
    always_comb begin
        ...
        if(decoded_reg_strb.I3CBase.RESET_CONTROL && decoded_req_is_wr) begin // SW write
            ...
            load_next_c = '1;
        end else if(hwif_in.I3CBase.RESET_CONTROL.CMD_QUEUE_RST.hwclr) begin // HW Clear
            next_c = '0;
            load_next_c = '1;
        end
    ...
    always_comb begin
        ...
        if(decoded_reg_strb.I3CBase.RESET_CONTROL && decoded_req_is_wr) begin // SW write
            ...
            load_next_c = '1;
        end else if(hwif_in.I3CBase.RESET_CONTROL.RESP_QUEUE_RST.hwclr) begin // HW Clear
            next_c = '0;
            load_next_c = '1;
        end
    ...
    always_comb begin
        ...
        if(decoded_reg_strb.I3CBase.RESET_CONTROL && decoded_req_is_wr) begin // SW write
            ...
            load_next_c = '1;
        end else if(hwif_in.I3CBase.RESET_CONTROL.TX_FIFO_RST.hwclr) begin // HW Clear
            next_c = '0;
            load_next_c = '1;
        end
    ...
    always_comb begin
        ...
        if(decoded_reg_strb.I3CBase.RESET_CONTROL && decoded_req_is_wr) begin // SW write
            ...
            load_next_c = '1;
        end else if(hwif_in.I3CBase.RESET_CONTROL.RX_FIFO_RST.hwclr) begin // HW Clear
            next_c = '0;
            load_next_c = '1;
        end
    ...
    always_comb begin
        ...
        if(decoded_reg_strb.I3CBase.RESET_CONTROL && decoded_req_is_wr) begin // SW write
            ...
            load_next_c = '1;
        end else if(hwif_in.I3CBase.RESET_CONTROL.IBI_QUEUE_RST.hwclr) begin // HW Clear
            next_c = '0;
            load_next_c = '1;
        end
    ...
    logic [116-1:0][31:0] readback_array;
    ...
    assign readback_array[110][1:0] = (decoded_reg_strb.I3C_EC.SoCMgmtIf.SYS_CLK_FREQ_REG && !decoded_req_is_wr) ? field_storage.I3C_EC.SoCMgmtIf.SYS_CLK_FREQ_REG.SYS_CLK_FREQ.value : '0;
    assign readback_array[110][31:2] = '0;
    assign readback_array[111][7:0] = (decoded_reg_strb.I3C_EC.CtrlCfg.EXTCAP_HEADER && !decoded_req_is_wr) ? 8'h2 : '0;
    assign readback_array[111][23:8] = (decoded_reg_strb.I3C_EC.CtrlCfg.EXTCAP_HEADER && !decoded_req_is_wr) ? 16'h2 : '0;
    assign readback_array[111][31:24] = '0;
    assign readback_array[112][3:0] = '0;
    assign readback_array[112][5:4] = (decoded_reg_strb.I3C_EC.CtrlCfg.CONTROLLER_CONFIG && !decoded_req_is_wr) ? field_storage.I3C_EC.CtrlCfg.CONTROLLER_CONFIG.OPERATION_MODE.value : '0;
    assign readback_array[112][31:6] = '0;
    assign readback_array[113][7:0] = (decoded_reg_strb.I3C_EC.TERMINATION_EXTCAP_HEADER && !decoded_req_is_wr) ? 8'h0 : '0;
    assign readback_array[113][23:8] = (decoded_reg_strb.I3C_EC.TERMINATION_EXTCAP_HEADER && !decoded_req_is_wr) ? 16'h1 : '0;
    assign readback_array[113][31:24] = '0;
    assign readback_array[114] = hwif_in.DAT.rd_ack ? hwif_in.DAT.rd_data : '0;
    assign readback_array[115] = hwif_in.DCT.rd_ack ? hwif_in.DCT.rd_data : '0;
